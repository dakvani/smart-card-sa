              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Add accessibility checks to ensure social icons and brand logos have proper alt text, keyboard focus, and color contrast across builder and public views."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Add accessibility checks to ensure social icons and brand logos have proper alt text, keyboard focus, and color contrast across builder and public views."}
                  </p>
                </div>
              );
