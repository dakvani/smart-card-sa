              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            see the broken icons fix it and icons on the appearance tab also do update with the actual icons, and apply these to all builder profiles, and live preview and the left tab names still not enhanced, it is shows over the boundary and not in align"
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            see the broken icons fix it and icons on the appearance tab also do update with the actual icons, and apply these to all builder profiles, and live preview and the left tab names still not enhanced, it is shows over the boundary and not in align"}
                  </p>
                </div>
              );
