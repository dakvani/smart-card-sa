              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Verify that LinkedIn, Discord, and all social icons render correctly on both the builder and the public profile after the latest changes.\n\nFix the icons that break in the Add New Link section so they display and align correctly in the builder and on the public profile.\n\nImplement text truncation and wrapping rules for ungrouped link fields like phone so the long text never overflows or repeats incorrectly on the public profile.\n\nAdd visual regression tests that specifically catch missing icons and alignment overflow for social icons and brand logos across builder and public views."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Verify that LinkedIn, Discord, and all social icons render correctly on both the builder and the public profile after the latest changes.\n\nFix the icons that break in the Add New Link section so they display and align correctly in the builder and on the public profile.\n\nImplement text truncation and wrapping rules for ungrouped link fields like phone so the long text never overflows or repeats incorrectly on the public profile.\n\nAdd visual regression tests that specifically catch missing icons and alignment overflow for social icons and brand logos across builder and public views."}
                  </p>
                </div>
              );
