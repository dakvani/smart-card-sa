              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            attached zip file contains all social media platform icons , gather the data from the zip file and assign where ever it  is needed in builder, link and appearance, also some users already build their profile and it is live under our site now, so the render the updates on those user profiles as well, where ever the icon has updated, update those old users too (this is very important)\n\nFix the LinkedIn (and other) social icons not appearing on my published profile page.\n\nAdd a clear fallback or placeholder behavior on the public profile when an icon URL is missing or fails to load.\n\nCreate an automated UI test that verifies social icons render correctly on the public profile after publishing.\n\nexcecate a details structural checking all around the page to test and examine the appearance, enhancement, color found, visual elements, and what not"
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            attached zip file contains all social media platform icons , gather the data from the zip file and assign where ever it  is needed in builder, link and appearance, also some users already build their profile and it is live under our site now, so the render the updates on those user profiles as well, where ever the icon has updated, update those old users too (this is very important)\n\nFix the LinkedIn (and other) social icons not appearing on my published profile page.\n\nAdd a clear fallback or placeholder behavior on the public profile when an icon URL is missing or fails to load.\n\nCreate an automated UI test that verifies social icons render correctly on the public profile after publishing.\n\nexcecate a details structural checking all around the page to test and examine the appearance, enhancement, color found, visual elements, and what not"}
                  </p>
                </div>
              );
