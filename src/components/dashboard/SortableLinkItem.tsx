              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Fix the LinkedIn (and other) social icons so they reliably appear on my published public profile pages.\n\nAdd a clear fallback or placeholder behavior on the public profile when a social icon URL is missing or fails to load.\n\nAutomatically re-render and update already-published user profiles so any social icon changes apply immediately to existing live pages.\n\nImport the social media platform icons from the uploaded zip file and wire them into the builder, link, and appearance components.\n\nCreate an automated UI test that verifies social icons render correctly on the public profile after publishing."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Fix the LinkedIn (and other) social icons so they reliably appear on my published public profile pages.\n\nAdd a clear fallback or placeholder behavior on the public profile when a social icon URL is missing or fails to load.\n\nAutomatically re-render and update already-published user profiles so any social icon changes apply immediately to existing live pages.\n\nImport the social media platform icons from the uploaded zip file and wire them into the builder, link, and appearance components.\n\nCreate an automated UI test that verifies social icons render correctly on the public profile after publishing."}
                  </p>
                </div>
              );
