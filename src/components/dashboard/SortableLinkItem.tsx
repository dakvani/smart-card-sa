              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            what is this below???\n\n'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.''' implement and verify strictly the points one by one 1. Implement a live preview that shows exactly what changed on my public profile before I publish it. 2. Add a publish status indicator that tells me when my updates are fully reflected on the live public page. 3. Implement validation so quoted instruction-like text cannot be mistakenly stored or displayed as normal user content. 4. Set up visual regression tests to catch icon breakage and alignment overflow before I release updates. 5. Add an automated check that confirms my social icons and brand logos render correctly on both the builder and public profiles. finally do a testing on each changes and make the results from 1 to 5\n\n12"
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            what is this below???\n\n'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.''' implement and verify strictly the points one by one 1. Implement a live preview that shows exactly what changed on my public profile before I publish it. 2. Add a publish status indicator that tells me when my updates are fully reflected on the live public page. 3. Implement validation so quoted instruction-like text cannot be mistakenly stored or displayed as normal user content. 4. Set up visual regression tests to catch icon breakage and alignment overflow before I release updates. 5. Add an automated check that confirms my social icons and brand logos render correctly on both the builder and public profiles. finally do a testing on each changes and make the results from 1 to 5\n\n12"
}
                  </p>
                </div>
