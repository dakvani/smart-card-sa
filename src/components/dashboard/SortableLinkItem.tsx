              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            I want to update my site's page titles and meta descriptions. The current title is \"SmartCard — NFC Business Cards & Digital Bio-Link Profiles\". The current description is \"SmartCard combines programmable NFC cards with a hosted bio-link profile builder. One tap shares your links, contact, and portfolio instantly.\". Ask me what I'd like the title and description to be — offer keeping the current values, a \"Let Lovable write it\" option, and writing my own. If I write my own value, use it verbatim as the site title or description — don't rewrite or riff on it. Apply the update everywhere the site defines its title and description — don't add new per-page metadata plumbing the project doesn't already have. Where pages already set their own titles, they may get a short page-specific prefix or suffix, but keep my wording intact. Don't add or change social share tags (og:, twitter:) beyond mirroring the final title and description."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            I want to update my site's page titles and meta descriptions. The current title is \"SmartCard — NFC Business Cards & Digital Bio-Link Profiles\". The current description is \"SmartCard combines programmable NFC cards with a hosted bio-link profile builder. One tap shares your links, contact, and portfolio instantly.\". Ask me what I'd like the title and description to be — offer keeping the current values, a \"Let Lovable write it\" option, and writing my own. If I write my own value, use it verbatim as the site title or description — don't rewrite or riff on it. Apply the update everywhere the site defines its title and description — don't add new per-page metadata plumbing the project doesn't already have. Where pages already set their own titles, they may get a short page-specific prefix or suffix, but keep my wording intact. Don't add or change social share tags (og:, twitter:) beyond mirroring the final title and description."}
                  </p>
                </div>
              );
