              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            .\n\nSet up visual regression and automated checks that specifically catch missing icons and alignment overflow for social icons and brand logos across builder and public views."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            .\n\nSet up visual regression and automated checks that specifically catch missing icons and alignment overflow for social icons and brand logos across builder and public views."}
                  </p>
                </div>
              );
