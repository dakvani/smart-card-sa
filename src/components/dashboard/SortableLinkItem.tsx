              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Implement a live preview that shows exactly what changed on the public profile before I publish it.\n\nAdd a publish status indicator that tells me when my updates are fully reflected on the live public page.\n\nImplement validation so quoted instruction-like text cannot be mistakenly stored or displayed as normal user content.\n\nSet up visual regression tests to catch icon breakage and alignment overflow before I release updates.\n\nAdd an automated check that confirms social icons and brand logos render correctly on both the builder and public profiles."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Implement a live preview that shows exactly what changed on the public profile before I publish it.\n\nAdd a publish status indicator that tells me when my updates are fully reflected on the live public page.\n\nImplement validation so quoted instruction-like text cannot be mistakenly stored or displayed as normal user content.\n\nSet up visual regression tests to catch icon breakage and alignment overflow before I release updates.\n\nAdd an automated check that confirms social icons and brand logos render correctly on both the builder and public profiles."}
                  </p>
                </div>
              );
