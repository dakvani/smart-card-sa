              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            still the links section icon such linked in is not appearing in public link and inthe builder, and the add new link section couple of icons still break. also this sections icons not apearing in public profile and the builder, also what is the long text under the ungrouped link like phone, many fucking times i have repeated the same propt and i gave got fucked up guys, so, TAKE OFF  the icon visualization that i have attached , i am fucking tired"
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            still the links section icon such linked in is not appearing in public link and inthe builder, and the add new link section couple of icons still break. also this sections icons not apearing in public profile and the builder, also what is the long text under the ungrouped link like phone, many fucking times i have repeated the same propt and i gave got fucked up guys, so, TAKE OFF  the icon visualization that i have attached , i am fucking tired"}
                  </p>
                </div>
              );
