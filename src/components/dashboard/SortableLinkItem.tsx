              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Dear Lovable, look at the attachment. This is my manager's profile that I have created the website, and I have introduced to him that this website can do one, two, three, and this was developed under lovable.dev. All right? But unfortunately, right now, I've been prompting multiple times for the same issue that is the profile icon, for example, LinkedIn and whatever, okay, from the, uh, built-in, uh, builder. All right? But until now, the hosted, published public profile v-view the, uh, the customized icon. The icon is not appearing. Look at the attachment on the, uh, below the general manager at Al Qadi Motors, and there are two points. Is the, the website, that's fine. That's a g-globe. A-and, and the left side that's supposed to be comes a LinkedIn icon. But see, I don't know how to fix it, and if you can do something, do it right now. Thank you."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Dear Lovable, look at the attachment. This is my manager's profile that I have created the website, and I have introduced to him that this website can do one, two, three, and this was developed under lovable.dev. All right? But unfortunately, right now, I've been prompting multiple times for the same issue that is the profile icon, for example, LinkedIn and whatever, okay, from the, uh, built-in, uh, builder. All right? But until now, the hosted, published public profile v-view the, uh, the customized icon. The icon is not appearing. Look at the attachment on the, uh, below the general manager at Al Qadi Motors, and there are two points. Is the, the website, that's fine. That's a g-globe. A-and, and the left side that's supposed to be comes a LinkedIn icon. But see, I don't know how to fix it, and if you can do something, do it right now. Thank you."}
                  </p>
                </div>
              );
