              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-pre-line">
                    {currentType === "whatsapp"
                      ? "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Convert the Appearance theme picker into a dropdown UI so users can select from up to four allowed options.\n\nImplement UI and state logic to enforce that the Appearance section supports only four theme options and block selecting a fifth option."
                      : "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Convert the Appearance theme picker into a dropdown UI so users can select from up to four allowed options.\n\nImplement UI and state logic to enforce that the Appearance section supports only four theme options and block selecting a fifth option."}
                  </p>
                </div>
              );
