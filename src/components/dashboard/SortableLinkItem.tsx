              ...
              return (
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground mt-1.5 leading-relaxed px-1 whitespace-pre-wrap">
                    {`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Run a visual regression test suite on the dashboard editor for iPhone and small Android screen sizes to confirm nothing overlaps.\n\nImplement automated layout checks for SortableLinkItem so its alignment remains consistent across common breakpoints.\n\nAdd a unit test that verifies all profile builder helper messages render the expected literal text and never include internal QA instructions.\n\nAdjust dashboard typography by standardizing line-heights and font sizes across components, then verify readability on mobile.`}
                  </p>
                </div>
              );
            }
